...
function generateMethod(method, url, operation, paramsType, bodyType) {
    const result = [];
...
function generateAPI(docs) {
    ...
    Object.keys(paths).forEach((url) => {
        ...
        TMETHOD.forEach((method) => {
            ...
            const paramsType = convert((_a = operation.parameters) === null || _a === void 0 ? void 0 : _a.filter((p) => p.in === 'path'));
            ...
            const bodyType = convert((_b = operation.parameters) === null || _b === void 0 ? void 0 : _b.filter((p) => p.in === 'formData'));
